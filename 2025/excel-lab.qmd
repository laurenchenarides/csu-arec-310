...
3. Answer the following in your notes (you’ll need this for Email 1):
   ...
   - What is the unit for `fmmocwt`? How does it differ from the retail price variables?
...
3. Format the column as **Date (MMM-YYYY)** for readability.  
...
1. Create a new worksheet named `Retailer_Prices_Comparison`.  
2. Using the same `Date` variable, add all five price series (`Jeminy_P`, `Cousins_P`, `Legals_P`, `FreshBetter_P`, `Greens_P`).  
...
5. Add a legend and clear labeling.
...
- Make sure your graphs appear on **separate worksheets** with descriptive names.  
